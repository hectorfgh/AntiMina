...
<body>
                    ...
                    <div class="col-12 col-md-6">
                        <div class="breaking-news-area">
                            ...
                            <div id="breakingNewsTicker" class="ticker">
                                <ul>
                                    <li><a href="#">Brexit breakthrough in Brussels comes after week of drama</a>
                                    </li>
            ...
            <div class="container h-100">
                <div class="row h-100 align-items-center">
                    ...
                    <div class="col-12 col-md-4">
                        <div class="logo-area">
                            <a href="index.html"><img src="{{ asset('assets/img/core-img/logo.png') }}"
                                    alt="logo"></a>
                        </div>
                    </div>
                    <!-- Header Advert Area -->
                    <div class="col-12 col-md-8">
                        <div class="header-advert-area">
                            <a href="#"><img src="{{ asset('assets/img/bg-img/top-advert.png') }}"
                                    alt="header-add"></a>
                        </div>
                    </div>
                </div>
                                ...
                                <div class="collapse navbar-collapse" id="gazetteMenu">
                                    <ul class="navbar-nav mr-auto">
                                        <li class="nav-item active">
                                            <a class="nav-link" href="#">Today <span
    ...
    <section class="welcome-blog-post-slide owl-carousel">
        ...
        <!-- Single Blog Post -->
        <div class="single-blog-post-slide bg-img background-overlay-5"
            style="background-image: url(assets/img/mina1.jpg);">
            <!-- Single Blog Post Content -->
            <div class="single-blog-post-content">
                <div class="tags">
                    <a href="#">Lo Ultimo</a>
                </div>
                <h3><a href="#" class="font-pt">San Gregorio en Alerta Roja</a></h3>
                <div class="date">
                    <a href="#">Diciembre 6, 2024</a>
                </div>
            </div>
        </div>
        <!-- Single Blog Post -->
        ...
        <div class="simple-marquee-container">
            <div class="marquee">
                <ul class="marquee-content-items">
                    <li>
                        <a href="#"><span class="latest-news-time">10:40</span> The Facebook Live stream that
                            could presage TV</a>
                    </li>
                    <li>
                        <a href="#"><span class="latest-news-time">11:02</span> Opinion: It's time to start
                            talking about impeachment</a>
                    </li>
                    <li>
                        <a href="#"><span class="latest-news-time">12:37</span> Clinton aims to shore up
                            Wisconsin with new TV ads</a>
                    </li>
                    <li>
                        <a href="#"><span class="latest-news-time">13:59</span> Trump signs tax bill before
                            leaving for Mar-a-Lago</a>
                    </li>
                </ul>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-12 col-lg-9">
                    ...
                    <div class="gazette-welcome-post">
                        ...
                        <h2 class="font-pt">Que sucede en San Gregorio?</h2>
                        <p class="gazette-post-date">Diciembre 6, 2024</p>
                        <!-- Post Thumbnail -->
                        <!-- Video Thumbnail -->
                        <div class="blog-post-thumbnail my-5">
                            <video controls width="100%" poster="img/blog-img/1.jpg" height="600px">
                                <source src="{{ asset('assets/img/sangregorio.mp4') }}" type="video/mp4">
                    ...
                    <div class="gazette-todays-post section_padding_100_50">
                        ...
                        <div class="gazette-single-todays-post d-md-flex align-items-start mb-50">
                            ...
                            <div class="todays-post-content">
                                ...
                                <h3><a href="#" class="font-pt mb-2">$250-million mansion is most expensive</a>
                                </h3>
                                ...
                                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse ultrices egestas
                                    ...
                                    viverra tincidunt dolor, at pulvinar dui. Nullam at risus ut ipsum viverra posuere.
                                </p>
                            </div>
                        </div>
                        <!-- Single Today Post -->
                    ...
                    <div class="sidebar-area">
                        ...
                        <div class="breaking-news-widget">
                            ...
                            <div class="single-breaking-news-widget">
                                <img src="{{ asset('assets/img/blog-img/bn-1.jpg') }}" alt="">
                            ...
                            <!-- Single Breaking News Widget -->
                            <div class="single-breaking-news-widget">
                                <img src="{{ asset('assets/img/mina1.jpg') }}" alt="">
                                <div class="breakingnews-title">
                                    <p>breaking news</p>
                                </div>
                                <div class="breaking-news-heading gradient-background-overlay">
                        ...
                        <div class="donnot-miss-widget">
                            ...
                            <div class="single-dont-miss-post d-flex mb-30">
                                <div class="dont-miss-post-thumb">
                                    <img src="{{ asset('assets/img/blog-img/dm-1.jpg') }}" alt="">
                                </div>
                            ...
                            <div class="single-dont-miss-post d-flex mb-30">
                                <div class="dont-miss-post-thumb">
                                    <img src="{{ asset('assets/img/blog-img/dm-2.jpg') }}" alt="">
                                </div>
                                <div class="dont-miss-post-content">
                            ...
                            <div class="single-dont-miss-post d-flex mb-30">
                                <div class="dont-miss-post-thumb">
                                    <img src="{{ asset('assets/img/blog-img/dm-3.jpg') }}" alt="">
                                </div>
                                <div class="dont-miss-post-content">
                        ...
                        <div class="advert-widget">
                            ...
                            <div class="advert-thumb mb-30">
                                <a href="#"><img src="{{ asset('assets/img/blog-img/advert.jpg') }}"
                                        alt=""></a>
                            </div>
                        </div>
                        <!-- Subscribe Widget -->
            ...
            <div class="container">
                <div class="row">
                    <div class="col-12 col-md-4">
                        ...
                        <div class="gazette-single-catagory-post">
                            <div class="single-catagory-post-thumb mb-15">
                                <img src="{{ asset('assets/img/blog-img/cat-1.jpg') }}" alt="">
                            </div>
                            <!-- Post Tag -->
                            <div class="gazette-post-tag">
                                <a href="#">Video</a>
                    ...
                    <div class="col-12 col-md-4">
                        <div class="row">
                            <div class="col-12 col-md-6">
                                ...
                                <div class="gazette-single-catagory-post">
                                    <div class="single-catagory-post-thumb mb-15">
                                        <img src="{{ asset('assets/img/blog-img/16.jpg') }}" alt="">
                                    </div>
                                    <!-- Post Tag -->
                                    <div class="gazette-post-tag">
                                        <a href="#">Others</a>
                                    </div>
                                    <h5><a href="#" class="font-pt">11 hottest toys for this holiday season</a>
                                    </h5>
                                    <span>Nov 29, 2017</span>
                                </div>
                            </div>
                            <div class="col-12 col-md-6">
                                ...
                                <div class="gazette-single-catagory-post">
                                    <div class="single-catagory-post-thumb mb-15">
                                        <img src="{{ asset('assets/img/blog-img/15.jpg') }}" alt="">
                                    </div>
                                    <!-- Post Tag -->
                                    <div class="gazette-post-tag">
                                        <a href="#">Video</a>
                            ...
                            <div class="col-12 col-md-6">
                                ...
                                <div class="gazette-single-catagory-post">
                                    <div class="single-catagory-post-thumb mb-15">
                                        <img src="{{ asset('assets/img/blog-img/14.jpg') }}" alt="">
                                    </div>
                                    <!-- Post Tag -->
                                    <div class="gazette-post-tag">
                                        <a href="#">Interview</a>
                            ...
                            <div class="col-12 col-md-6">
                                ...
                                <div class="gazette-single-catagory-post">
                                    <div class="single-catagory-post-thumb mb-15">
                                        <img src="{{ asset('assets/img/blog-img/17.jpg') }}" alt="">
                                    </div>
                                    <!-- Post Tag -->
                                    <div class="gazette-post-tag">
                                        <a href="#">Video</a>
                    ...
                    <div class="col-12 col-md-4">
                        ...
                        <div class="gazette-single-catagory-post">
                            <div class="single-catagory-post-thumb mb-15">
                                <img src="{{ asset('assets/img/blog-img/18.jpg') }}" alt="">
                            </div>
                            <!-- Post Tag -->
                            <div class="gazette-post-tag">
                                <a href="#">Video</a>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-12 col-md-3">
                    <div class="single-video-post">
                        <div class="video-post-thumb">
                            <img src="{{ asset('assets/img/blog-img/10.jpg') }}" alt="">
                            <a href="https://youtu.be/dIyXl9ZHEgg" class="videobtn"><i class="fa fa-play"
                                    aria-hidden="true"></i></a>
                        </div>
                ...
                <div class="col-12 col-md-3">
                    <div class="single-video-post">
                        <div class="video-post-thumb">
                            <img src="{{ asset('assets/img/blog-img/11.jpg') }}" alt="">
                            <a href="https://youtu.be/dIyXl9ZHEgg" class="videobtn"><i class="fa fa-play"
                                    aria-hidden="true"></i></a>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-12 col-md-5">
                                    <div class="editorial-post-thumb">
                                        <img src="{{ asset('assets/img/blog-img/bitcoin.jpg') }}" alt="">
                                    </div>
                                </div>
